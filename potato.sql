...
INSERT INTO `Ken_stocks` VALUES ('A',1),('K',2),('F',5),('G',1),('T',2),('Y',5),('B',1);
/*!40000 ALTER TABLE `Ken_stocks` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Kenn_stocks`
--

DROP TABLE IF EXISTS `Kenn_stocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Kenn_stocks` (
  `symbol` varchar(15) DEFAULT NULL,
  `amt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `Kenn_stocks`
--

LOCK TABLES `Kenn_stocks` WRITE;
/*!40000 ALTER TABLE `Kenn_stocks` DISABLE KEYS */;
/*!40000 ALTER TABLE `Kenn_stocks` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `TEST_stocks`
--

DROP TABLE IF EXISTS `TEST_stocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `TEST_stocks`
--

LOCK TABLES `TEST_stocks` WRITE;
/*!40000 ALTER TABLE `TEST_stocks` DISABLE KEYS */;
/*!40000 ALTER TABLE `TEST_stocks` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `hash_stocks`
--

DROP TABLE IF EXISTS `hash_stocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hash_stocks` (
  `symbol` varchar(15) DEFAULT NULL,
  `amt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `hash_stocks`
--

LOCK TABLES `hash_stocks` WRITE;
/*!40000 ALTER TABLE `hash_stocks` DISABLE KEYS */;
/*!40000 ALTER TABLE `hash_stocks` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `students` VALUES ('hash','43f795f7132c002f9ed332a97d18bd02db9d7277840c99b89c4da57149a23eaf',18,NULL,10000.00,10000.00),('Kenn','fb6a1ac3cce9a55095916bd24e67b6ab5623ef9004628d737264fb0c85b2f64d',19,NULL,10000.00,10000.00),('Ken','fb6a1ac3cce9a55095916bd24e67b6ab5623ef9004628d737264fb0c85b2f64d',20,NULL,10000.00,22182.37),('Hemanth','cda17cdfcfd3aa2acb54884d8a4a0b138e781e57a8365d0f2bee379c90274a3f',21,NULL,10000.00,10000.00),('TEST','fb6a1ac3cce9a55095916bd24e67b6ab5623ef9004628d737264fb0c85b2f64d',22,NULL,10000.00,10000.00);
...
-- Dump completed on 2019-12-15 13:50:31
